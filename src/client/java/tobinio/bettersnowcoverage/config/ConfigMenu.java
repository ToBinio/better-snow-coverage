        ...
        return parentScreen -> YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(ListOption.<String>createBuilder()
                                ...
                                .description(OptionDescription.of(Text.literal("These blocks will NEVER show snow underneath them.")))
                        ...
                        .option(ListOption.<String>createBuilder()
                                ...
                                .description(OptionDescription.of(Text.literal("All blocks within these tags will NEVER show snow underneath them.")))
